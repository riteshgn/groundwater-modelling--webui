...
<script>
    ...
    const CanvasSummary = {
        ...
        props: {
            showSelectionFlag: { type: Boolean, default: false }
        },

        computed: {
            ...mapState('app', ['editableCanvas']),
            ...mapGetters('groundwater', ['canvasSummary']),

            selection() {
                return this.editableCanvas ? 'ON' : 'OFF';
            }
        }
